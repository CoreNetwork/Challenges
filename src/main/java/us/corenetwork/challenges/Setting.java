...
public enum Setting {
	...
	MESSAGE_ENTER_DESCRIPTION("Messages.EnterDescription", "Enter description for this level into chatbox. If you reach chatbox limit, just hit enter and continue with next line. Enter &a/done&f to finish entering message."),
	MESSAGE_OLD_DESCRITPION("Messages.OldDescription", "Previous description: &e<Desc>&f (Enter &a-1&f to leave it as is)"),
	MESSAGE_DESCRPITION_PART_ENTERED("Messages.DescriptionPartEntered", "Description received. Keep typing or send /done to finish"),
