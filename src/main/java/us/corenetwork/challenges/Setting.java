...
public enum Setting {
	...
	MESSAGE_MOD_HISTORY_ENTRY("Messages.ModHistory.Entry", "&b#<ID> <State>&7, <time> ago"),
	MESSAGE_MOD_HISTORY_ENTRY_PLAYER("Messages.ModHistory.EntryPlayer", "&b#<ID> <State> &7by <moderator>, <time> ago"),
