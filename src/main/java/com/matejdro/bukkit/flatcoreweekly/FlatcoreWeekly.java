...
import com.matejdro.bukkit.flatcoreweekly.admincommands.AdminHelpCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.BaseAdminCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.DeleteLevelCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.EditLevelCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.EditWeekCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.ExitCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.ImportCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.ListCommand;
import com.matejdro.bukkit.flatcoreweekly.admincommands.ReloadCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.BaseModCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.CompleteCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.CompletedListCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.DenyCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.LockCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.ModHelpCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.ModPointsCommand;
import com.matejdro.bukkit.flatcoreweekly.modcommands.TpCommand;
import com.matejdro.bukkit.flatcoreweekly.usercommands.AllCommand;
import com.matejdro.bukkit.flatcoreweekly.usercommands.BaseUserCommand;
import com.matejdro.bukkit.flatcoreweekly.usercommands.ChCommand;
import com.matejdro.bukkit.flatcoreweekly.usercommands.DoneCommand;
import com.matejdro.bukkit.flatcoreweekly.usercommands.PointsCommand;
import com.matejdro.bukkit.flatcoreweekly.usercommands.UserHelpCommand;

public class FlatcoreWeekly extends JavaPlugin {
	public static Logger log = Logger.getLogger("Minecraft");

	private FlatcoreListener listener;
	
	public static FlatcoreWeekly instance;
	...
	{
		Bukkit.getServer().getScheduler().cancelTasks(FlatcoreWeekly.instance);
		Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(FlatcoreWeekly.instance, new WeekAnnouncer(), WeekAnnouncer.getNextTime());
	}
