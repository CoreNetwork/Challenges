...
public enum Setting {
	...
	MESSAGE_ENTER_DESCRIPTION("Messages.EnterDescription", "Enter description for this level into chatbox. If you reach chatbox limit, just hit enter and continue with next line. Enter &adone&f to finish entering message."),
